  ...
  var SmartWizard = /*#__PURE__*/function () {
    ...
    _createClass(SmartWizard, [{
      ...
      value: function _createToolbar(position) {
        ...
        var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text(this.options.lang.next).addClass('btn btn-colored sw-btn-next').attr('type', 'button') : null;
        var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text(this.options.lang.previous).addClass('btn btn-white sw-btn-prev').attr('type', 'button') : null;
    ...
    }, 
	{
      ...
      value: function _doStepAnimation(idx, callback) {
        ...
        var curPage = this._getStepPage(this.current_index); 


        var selPage = this._getStepPage(idx); 

        var animation = this.options.transition.animation.toLowerCase(); 
